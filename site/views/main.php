 <div id="wapper-main">
    <div id="group-product-title" class="navbar navbar-default">
      <?php foreach($this->listProductSmartPhone as $key=>$value): ?>
      <div class="navbar-brand text-uppercase"><a href="product/<?php echo $value->gruop_url; ?>"><?php echo $value->gruop_url; break;?>
      <?php endforeach; ?> </a>
    </div>
  </div>
  <div class="row ">
  ...
  <div id="group-product-title" class="navbar navbar-default">
      <?php foreach($this->listProductLaptop as $key=>$value): ?>
      <div class="navbar-brand text-uppercase"><a href="product/<?php echo $value->gruop_url; ?>"><?php echo $value->gruop_url; break;?>
      <?php endforeach; ?> 
    </div>
  </div>
  ...
  <div id="group-product-title" class="navbar navbar-default">
      <?php foreach($this->listProductTablet as $key=>$value): ?>
      <div class="navbar-brand text-uppercase"><a href="product/<?php echo $value->gruop_url; ?>"><?php echo $value->gruop_url; break;?>
      <?php endforeach; ?> 
    </div>
  </div>
  ...
  <div id="group-product-title" class="navbar navbar-default">
      <?php foreach($this->listProductAccessories as $key=>$value): ?>
      <div class="navbar-brand text-uppercase"><a href="product/<?php echo $value->gruop_url; ?>"><?php echo $value->gruop_url; break;?>
      <?php endforeach; ?> 
    </div>
  </div>
